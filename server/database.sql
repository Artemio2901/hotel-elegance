CREATE DATABASE IF NOT EXISTS hotel_elegance;
USE hotel_elegance;
...
INSERT IGNORE INTO users (id, fullname, email, username, passwordHash, role, createdAt) VALUES 
...
-- Habitaciones
INSERT IGNORE INTO rooms (id, title, price, icon, badge, description, available) VALUES 
...
INSERT IGNORE INTO room_features (room_id, feature) VALUES 
...
-- Ofertas
INSERT IGNORE INTO offers (id, title, badge, icon, description, oldPrice, newPrice, validity) VALUES 
...
INSERT IGNORE INTO offer_includes (offer_id, include_text) VALUES 
